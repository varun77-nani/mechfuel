...
// Service options with display names
const SERVICE_OPTIONS = [
  { id: 'battery_jumpstart', name: 'Battery Jumpstart', price: 25 },
  { id: 'tire_change', name: 'Tire Change', price: 40 },
  { id: 'lockout_service', name: 'Lockout Service', price: 30 },
  { id: 'tow_service', name: 'Tow Service', price: 75 },
  { id: 'fuel_delivery', name: 'Fuel Delivery', price: 15 },
  { id: 'engine_repair', name: 'Engine Repair', price: 100 },
  { id: 'other', name: 'Other Service', price: 50 }
];
...
export default function ServiceRequest() {
  ...
  // Remove unused handleNext function
